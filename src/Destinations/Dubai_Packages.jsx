          ...
          <div className="flex flex-col shadow-lg shadow-black rounded-lg mt-5 md:flex-row text-black text-md md:h-auto max-w-7xl">
            <div className="md:w-full p-5  md:h-auto">
              ...
              <p className="mt-2 text-md md:text-xl pt-8 leading-6 md:leading-1">
                ...
                ancient traditions meet cutting-edge modernity, offering a
                one-of-a-kind experience to travelers. Known for its
                record-breaking skyline dominated by the world-famous Burj
                Khalifa, Dubai also preserves its rich Arabian heritage through
                souks, historic districts, and cultural festivals. Visitors can
                explore the bustling Dubai Creek area, where traditional abras
                (boats) ferry passengers across the water, and step into the
                past at the Al Fahidi Historical Neighborhood. Architecture and
                Modern Marvels The city is synonymous with futuristic
                architecture and innovation. The Burj Khalifa, the tallest
                building in the world, provides breathtaking views of the city,
                while the iconic Burj Al Arab stands as a symbol of luxury and
                opulence. Dubai is also home to the Palm Jumeirah, a man-made
                island shaped like a palm tree, which hosts luxury resorts, fine
                dining, and stunning beachfront views. For those seeking a
                glimpse into the future, the Museum of the Future showcases
                cutting-edge technology and visions of tomorrow. Shopping and
                Retail Therapy Dubai is a global shopping destination, with the
                Dubai Mall being one of the largest shopping centers in the
                world. Here, visitors can find luxury brands, high-end fashion,
                electronics, and traditional crafts, all under one roof. The
                mall also features attractions like the Dubai Aquarium and an
                indoor ice rink. For a more traditional shopping experience, the
                ...
                international cuisines that reflect Dubai’s multicultural
                population. Beachside cafés, rooftop lounges, and world-class
                eateries ensure that every meal is a memorable experience.
                {seeMore && (
                  <span>
                    Adventure and Leisure Dubai offers a wide range of leisure
                    activities and adventure sports. For thrill-seekers, the
                    desert is a playground for dune bashing, sandboarding, and
                    camel rides, while the city’s coastline offers water sports
                    like jet skiing and parasailing. Indoor attractions like Ski
                    Dubai, the world’s largest indoor ski resort, provide unique
                    experiences amidst the desert heat. For nature lovers, a
                    visit to the Dubai Miracle Garden, with its stunning floral
                    displays, is a must-see. Cultural Heritage While Dubai is a
                    city of modern wonders, it also treasures its cultural
                    heritage. The Sheikh Mohammed Centre for Cultural
                    Understanding offers insight into Emirati traditions,
                    including tours of local mosques and traditional meals.
                    Visitors can also experience the grandeur of Arabian
                    hospitality at desert resorts, where they can enjoy
                    Bedouin-style dining and entertainment under the stars.
                    Nightlife and Entertainment When the sun sets, Dubai’s
                    nightlife comes alive with a variety of options. From beach
                    clubs to rooftop lounges with views of the city’s
                    illuminated skyline, the nightlife in Dubai is as dynamic as
                    its daytime attractions. The city is home to world-renowned
                    nightclubs and live entertainment venues where international
                    DJs perform. Visitors can also enjoy a magical evening on a
                    dhow cruise along Dubai Creek or the Marina, with dinner and
                    traditional music onboard. Festivals and Events Dubai’s
                    event calendar is filled with international festivals,
                    including the Dubai Shopping Festival and Dubai Food
                    Festival, which celebrate the city’s love for shopping and
                    gastronomy. Cultural events like the Dubai International
                    Film Festival and Art Dubai highlight the city’s growing
                    reputation as a global cultural hub, while sporting events
                    like the Dubai World Cup (horse racing) and the Dubai Tennis
                    Championships attract top athletes from around the world.
                    From its shimmering skyscrapers to its vast desert
                    landscapes, Dubai offers an extraordinary blend of luxury,
                    tradition, and adventure. Whether you’re marveling at its
                    architectural wonders, indulging in world-class cuisine, or
                    exploring its cultural heritage, Dubai promises a truly
          ...
          <div className="flex flex-wrap md:flex-row p-8 mt-8 mb-8 border-2 rounded-lg border-gray-600 w-full md:max-w-7xl">
            ...
            <div className="ml-6 md:ml-8">
              <p className="text-lg md:text-2xl font-bold">
                PREMIUM DUBAI INTERNATIONAL TRIP 10 NIGHTS 11 DAYS
              </p>
