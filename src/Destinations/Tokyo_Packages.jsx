  ...
  return (
    <>
      ...
      <div className="w-full font-oswald">
        <div className="w-full h-80 md:h-[500px] bg-cover bg-center" style={{ backgroundImage: `url(${Tokyo})` }}>
          {/* image */}
        </div>
        ...
        <div className="md:w-full p-5 md:h-auto">
            ...
            style= {{textShadow:'2px 2px 4px rgba(0.5,0,0.5,0.5)'}}>
              Tokyo: A Fusion of Tradition and Modernity</p> 
            <p className="mt-2 text-md md:text-2xl pt-8 leading-6 md:leading-1">
            Tokyo, the bustling capital of Japan, is a city where cutting-edge technology coexists with ancient traditions, offering an unmatched experience to travelers. Known for its stunning skyline adorned with towering skyscrapers, Tokyo also preserves its rich cultural heritage through temples, shrines, and historic landmarks. A visit to the iconic Senso-ji Temple in Asakusa allows visitors to step back in time, while the modern Shibuya Crossing showcases the city's vibrant urban energy.
            The city is renowned for its shopping districts like Ginza and Harajuku, where fashion, electronics, and traditional crafts can be found. Food lovers can indulge in Tokyo's world-famous culinary scene, from sushi at Tsukiji Fish Market to exquisite ramen in countless eateries. For a true cultural experience, try a traditional tea ceremony or witness sumo wrestling, Japan's national sport.
              {seeMore && (
                <span>
                    Beyond its modern attractions, Tokyo offers serene parks and gardens like the Shinjuku Gyoen and Ueno Park, perfect for relaxation amidst the urban hustle. The city’s cherry blossom season in spring is an enchanting spectacle, drawing tourists from around the world.
                    For tech enthusiasts and anime fans, Akihabara is a paradise filled with electronics stores and anime shops, while Odaiba’s futuristic waterfront provides thrilling experiences like teamLab’s digital art exhibitions. Visitors can also enjoy panoramic views of the city from the Tokyo Skytree or Tokyo Tower.
                    As night falls, Tokyo’s dazzling nightlife takes center stage. Whether it's karaoke, exploring lively neighborhoods like Shinjuku and Roppongi, or savoring a cocktail at a sky bar with views of the glittering city lights, Tokyo ensures an unforgettable after-dark experience. From traditional festivals to futuristic attractions, Tokyo offers a journey into the heart of Japan’s vibrant culture and innovation.
                </span>
              )}
              <span
        ...
        <div className="flex flex-wrap md:flex-row p-8 mt-8 mb-8 border-2 rounded-lg border-gray-600 w-full md:max-w-8xl">
          <div className="w-full md:w-44 md:h-44   h-60 flex items-center justify-center">
            <img src={Tokyo} className="w-full h-full object-cover" alt="Tokyo" />
          </div>

          <div className="ml-6 md:ml-8">
            <p className="text-lg md:text-2xl font-bold">PREMIUM TOKYO INTERNATIONAL TRIP 10 NIGHTS 11 DAYS</p> 
