        ...
        <div className="w-full h-auto flex justify-center px-4 md:px-0 font-oswald ">
          <div className="flex flex-col shadow-lg shadow-black rounded-lg mt-5 md:flex-row text-black text-md md:h-auto max-w-7xl">
            <div className="md:w-full p-5  md:h-auto">
              <p
                className="text-xl md:text-3xl font-bold text-center text-black"
                style={{ textShadow: "2px 2px 4px rgba(0.5,0,0.5,0.5)" }}
              >
                Kerala: A Symphony of Nature and Tradition
              </p>
              <p className="mt-2 text-md md:text-xl pt-8 leading-6 md:leading-1">
                Kerala, often referred to as “God’s Own Country,” is a land
                where lush green landscapes and serene backwaters blend with
                rich cultural traditions, offering travelers a magical
                experience. Known for its tranquil beauty, Kerala’s tropical
                charm is seen in its rolling hills, pristine beaches, and
                sprawling tea plantations. A visit to the serene backwaters of
                Alleppey allows visitors to experience life in houseboats,
                drifting along palm-fringed canals that have been a part of
                Kerala’s culture for centuries. The state is equally renowned
                for its historic temples, churches, and traditions. From the
                sacred Sabarimala Temple to the age-old Jewish Synagogue in
                Kochi, Kerala’s diverse cultural heritage offers something for
                everyone. The state’s famed Kathakali dance performances, with
                their intricate costumes and expressive storytelling, allow
                visitors to step into the world of classical art, while the
                traditional Ayurvedic spas provide healing and relaxation like
                nowhere else. Shopping and Markets Kerala is home to vibrant
                markets where traditional spices, handloom sarees, and artisanal
                crafts can be found. The bustling streets of Kochi and
                Trivandrum blend modern boutiques with traditional handicraft
                stores, where you can find everything from intricate jewelry to
                handmade coir products, reflecting the state’s dedication to
                preserving its cultural roots while embracing modern trends.
                Culinary Experience.
                {seeMore && (
                  <span>
                    Food lovers will delight in Kerala’s world-famous culinary
                    offerings, particularly its seafood delicacies like fish
                    moilee and prawn curry. From feasting on a traditional
                    Sadhya meal served on banana leaves to savoring crispy dosas
                    in street-side cafes, Kerala’s cuisine is an irresistible
                    blend of flavors. Don’t miss trying the local favorite,
                    Kerala’s own toddy, made from coconut sap. Nature and
                    Adventure Beyond its cultural heritage, Kerala is known for
                    its natural wonders. The misty hill stations of Munnar and
                    Wayanad, with their endless tea gardens and wildlife
                    sanctuaries, are perfect for trekking and nature walks. The
                    Periyar Wildlife Sanctuary offers a glimpse into the state’s
                    rich biodiversity, while Kerala’s beaches like Varkala and
                    Kovalam invite visitors to relax and enjoy water sports like
                    surfing and parasailing. Modern Development Kerala’s cities
                    are steadily modernizing, with new infrastructure, shopping
                    malls, and entertainment hubs emerging in places like Kochi
                    and Trivandrum. However, the state’s development doesn’t
                    overshadow its dedication to eco-tourism and sustainable
                    practices, ensuring that the natural beauty remains
                    preserved for future generations. Nightlife and Festivals As
                    night falls, Kerala’s cities offer a peaceful yet lively
                    atmosphere. Enjoy an evening at one of Kochi’s rooftop cafes
                    or watch a sunset over Varkala Beach, while cultural
                    enthusiasts can attend temple festivals and traditional
                    dances, which are celebrated with grandeur throughout the
                    year. The famous Onam festival, with its vibrant
                    processions, flower decorations, and boat races, captures
                    the true spirit of Kerala’s deep-rooted traditions. From its
                    tranquil backwaters to its vibrant cities, Kerala offers a
                    perfect fusion of nature, tradition, and modernity. Whether
                    you’re exploring its spice-scented markets or relaxing in a
                    mountain retreat, Kerala promises an experience that is both
                    rejuvenating and culturally enriching.
                  </span>
                )}
                <span
          ...
          <div className="flex flex-wrap md:flex-row p-8 mt-8 mb-8  border-2 rounded-lg border-gray-600 w-full md:max-w-7xl">
            ...
            <div className="ml-6 md:ml-8">
              <p className="text-lg md:text-2xl font-bold">
                PREMIUM KERALA DOMESTIC TRIP 10 NIGHTS 11 DAYS
              </p>
