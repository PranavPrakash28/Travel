...
function Loc_Europe() {
  ...
  return (
    <>
      ...
      <div className='w-full h-auto flex justify-center px-4 md:px-0 font-oswald'>
      <div className="max-w-7xl rounded-3xl mt-10  p-8 md:py-10   flex flex-col md:flex justify-between items-center gap-10">
            <p className="text-xl md:text-4xl  font-bold md:text-start"
            style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0)' }}>Europe: A Continent of Endless Discovery</p> 
