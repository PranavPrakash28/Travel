    ...
    <>
      ...
      <div className="w-full font-oswald">
        <div
          ...
          style={{ backgroundImage: `url(${Singapore01})` }}
        >
          {/* image */}
        </div>
        ...
        <div className="flex flex-col md:flex-row  rounded-2xl  mt-10 md:max-w-7xl mx-auto px-4 text-md md:h-auto">
          <div className="md:w-full  p-5  md:h-auto">
            ...
            <p className="mt-2 text-md md:text-xl pt-8 leading-6 md:leading-1">
              ...
              nation is a dazzling mix of towering skyscrapers, heritage-rich
              neighbourhoods, and lush green spaces. Whether you’re a solo
              traveller, a family on vacation, or a couple on a romantic
              getaway, Singapore has something for everyone.
              {seeMore && (
                <span>
          ...
          {/* <div className="md:w-1/4 text-sm h-auto md:h-auto md:text-sm bg-white text-black p-5 md:block">
            ...
            >
              All Facts About Singapore: Did You Know?
            </p>
            <Link to="/contact">
              <p className="  text-lg text-red-600 cursor-pointer underline">
                Ask from Experts
              </p>
            </Link>
          </div> */}
          ...
          >
            ...
            {expandedContent === "exclusive" && (
              <div className="pt-2 md:text-xl font-light">
                <p>
                  Every nook and cranny of Singapore offers a luxurious
                  experience for your palate. From high-end gourmet restaurants
                  to local street food, you'll find it all OH-SO-CHIC! For an
                  authentic Singaporean meal, visit Lau Pa Sat, a bustling
                  hawker centre offering everything from Hainanese chicken rice
                  to satay skewers and laksa. If you're in the mood for seafood,
                  Singapore’s signature dish, chilli crab, is a must-try. Head
                  to Jumbo Seafood or Long Beach Seafood for the best version of
                  this spicy, sweet, and savoury delight.
                </p>
                <p>
                  For those seeking a refined dining experience, Odette, a
                  Michelin-starred French restaurant, is the pinnacle of
                  sophistication. Or, you can savour innovative dishes at Burnt
                  Ends, where modern barbecue meets Singaporean flair.
                </p>
              </div>
            )}
            ...
            {expandedContent === "restaurants" && (
              <div className="pt-2 md:text-xl font-light">
                <p>
                  Your journey begins with GSK World Travels, which offers a
                  wide range of all-inclusive packages tailored to your needs.
                  Whether you're a family looking to create memorable moments, a
                  group of friends seeking adventure, or a couple on a romantic
                  honeymoon, GSK World Travels has the perfect holiday package
                  for you.
                </p>
                <p>
                  For families, Singapore offers exciting options like Sentosa
                  Island, home to Universal Studios Singapore, the interactive
                  S.E.A. Aquarium, and the fun-filled Adventure Cove Waterpark.
                  With GSK's family-friendly packages, all these and more can be
                  seamlessly woven into your itinerary.
                </p>
                <p>
                  If you're an adventure-loving bachelor or part of a group,
                  you’ll love the adrenaline-pumping activities like indoor
                  skydiving at iFly, the thrilling AJ Hackett Sentosa Bungy
                  Jump, or jet-skiing across the Singapore waters. Those seeking
                  romance can opt for a sunset cruise along Marina Bay or a
                  candlelit dinner at one of the city's rooftop restaurants.
                </p>
                <p>
                  With GSK World Travels, you can expect hassle-free planning
                  with carefully designed packages that cover accommodations,
                  meals, and guided tours. Whether it’s luxury or budget travel,
                  GSK ensures every detail is taken care of so you can focus on
                  enjoying Singapore.
                </p>
              </div>
            )}
            ...
            {expandedContent === "places" && (
              <div className="pt-2 md:text-xl font-light">
                <p>
                  When the sun sets, Singapore howls into a playground for night
                  owls. From rooftop bars with panoramic city views to bustling
                  night markets and pulsating nightclubs, the nightlife here is
                  second to none. Clarke Quay is the heart of the action, where
                  you can dance the night away at spots like Zouk or sip
                  cocktails at the iconic CÉ LA VI atop the Marina Bay Sands.
                </p>
                <p>
                  For those who prefer a more laid-back evening filled with
                  lighthearted walks, night markets like Chinatown Street Market
                  offer a blend of shopping, food, and culture under twinkling
                  lights. If you're looking for something unique, do not miss
                  out on a night safari at the Singapore Zoo, where you can see
            ...
            {expandedContent === "nightlife" && (
              <div className="pt-2 md:text-xl font-light">
                <p>
                  Singapore offers a wide variety of activities that are enjoyed
                  by all types of travellers. Begin your journey at Marina Bay
                  Sands, one of Singapore’s most iconic structures, where you
                  can enjoy panoramic views from the SkyPark Observation Deck or
                  take a dip in the world-famous infinity pool.
                </p>
                <p>
                  Explore the futuristic gardens at Gardens by the Bay, with its
                  towering Supertree Grove, indoor waterfalls, and biodomes
                  filled with exotic plants from around the globe. At night, the
                  Supertrees come alive with a stunning light show, creating an
                ...
                <p>
                  Families can explore the world-renowned Singapore Zoo and its
                  famous Night Safari, where nocturnal animals roam in
                  naturalistic habitats. The Jurong Bird Park and River Wonders
                  also offer family-friendly, wildlife-themed adventures.
                </p>
              </div>
            )}
            ...
            {expandedContent === "nightlife" && (
              <div className="pt-2 md:text-xl font-light">
                <p>
                  A trip without the chills and thrills is way too elegant to be
                  true right? Well you're in for a treat! Singapore has no
                  shortage of these adrenaline-pumping activities. Sentosa
                  Island is a go-to destination for thrill-seekers, offering
                  activities like zip-lining at Mega Adventure Park and the
                  heart-stopping Bungy Jump at AJ Hackett Sentosa.{" "}
                ...
                <p>
                  Water sports enthusiasts can enjoy the splashes while
                  jet-skiing, wakeboarding, and kayaking at Singapore’s beaches.
                  The island’s coastline is a bedrock for water-based activities
                  that will quench your thirst for adventure.
                </p>
              </div>
            )}
            ...
            {expandedContent === "beaches" && (
              <div className="pt-2 md:text-xl font-light">
                <p>
                  Singapore’s culinary offerings are as diverse as its people.
                  From the humble hawker centers to award-winning fine dining,
                  there's something for everyone. Don’t miss iconic Singaporean
                  dishes like Hainanese chicken rice, a simple yet flavorful
                  meal beloved by locals and tourists alike. Another must-try is
                  laksa, a spicy noodle soup that’s bursting with coconut and
                  seafood flavours.
                </p>
                <p>
                  For dessert, cool off with ice kachang, a mountain of shaved
                  ice topped with sweet syrups, or dive into the rich and creamy
                  kaya toast, a breakfast staple served with soft-boiled eggs.
                  If you're a seafood lover, make sure to sample Singapore’s
                  famous chilli crab and black pepper crab.
                </p>
              </div>
            )}
            ...
            {expandedContent === "passport" && (
              <div className="pt-2 md:text-xl font-light">
                <p>
                  Before you set off on your Singaporean adventure, there are a
                  few essential things to know. First, the local currency is the
                  Singapore dollar (SGD), so make sure to exchange your money
                  ahead of time or withdraw from ATMs available across the city.
                  Singapore’s weather is tropical and warm year-round, with
                  average temperatures between 25°C to 31°C (77°F to 88°F).
                  While the city is generally dry, it experiences short, heavy
                  rain showers so be sure to pack an umbrella.
                </p>
                <p>
                  Time-wise, Singapore follows the GMT+8 time zone, which is
                  important to note when planning your flights or meetings.
            ...
            {expandedContent === "facts" && (
              <div className="pt-2 md:text-xl font-light">
                <p>
                  One of the most luxurious ways to experience Singapore and the
                  surrounding islands is by embarking on a cruise. Whether it's
                  a short getaway to Malaysia or a longer journey around
                  Southeast Asia, the cruise experience offers world-class
                  facilities, delectable dining, and mesmerising ocean views.
                  Popular cruise lines like Royal Caribbean and Genting Dream
                  Cruises offer routes departing from Singapore, making it a top
                  choice for travellers seeking both adventure and relaxation.
                </p>
              </div>
            )}
            ...
            {expandedContent === "inclusive" && (
              <div className="pt-2 md:text-xl font-light">
                <ul>
                  ...
                  <li>
                    -The Merlion, a mythical creature with the head of a lion
                    and the body of a fish, is the national symbol of Singapore.
                  </li>
                  <li>
                    -Singapore is one of the greenest cities in the world, with
                    nearly 50% of its land covered by greenery.
                  </li>
                  <li>
                    The city is home to the world’s largest rooftop infinity
                    pool at Marina Bay Sands.
