  ...
  return (
    <>
      ...
      <div className="w-full font-oswald">
        <div className="w-full h-80 md:h-[500px] bg-cover bg-center" style={{ backgroundImage: `url(${Maldives})` }}>
          {/* image */}
        </div>
        ...
        <div className="flex flex-col shadow-lg shadow-black rounded-lg mt-5 md:flex-row text-black text-md md:h-auto max-w-7xl">  
          <div className="md:w-full p-5 md:h-auto">
            ...
            style= {{textShadow:'2px 2px 4px rgba(0.5,0,0.5,0.5)'}}>Maldives: A Tropical Paradise of Serenity and Luxury</p> 
            <p className="mt-2 text-md md:text-2xl pt-8 leading-6 md:leading-1">
           
                The Maldives, a breathtaking archipelago in the Indian Ocean, is synonymous with pristine white-sand beaches, turquoise waters, and an unparalleled sense of tranquility. Known for its luxurious overwater villas and crystal-clear lagoons, the Maldives offers a tropical getaway where nature's beauty meets the pinnacle of relaxation and indulgence. This island paradise is made up of over 1,000 coral islands, each boasting its own unique charm and allure.
                Beaches and Natural Beauty
                The Maldives is renowned for its idyllic beaches, where powdery white sands meet warm, azure waters. Popular islands like Maafushi, Hulhumale, and the exclusive private resorts offer visitors a chance to unwind in pure paradise. Snorkeling and diving in the Maldives are world-class experiences, with vibrant coral reefs and an abundance of marine life, including colorful fish, manta rays, and sea turtles, just waiting to be explored.
                Luxury and Overwater Villas
                The Maldives is known for its luxurious resorts, each situated on its own private island. These resorts offer world-class hospitality, with overwater bungalows that allow guests to wake up to stunning views of the Indian Ocean. From private plunge pools to underwater restaurants, the Maldives sets the standard for luxury. Whether you’re seeking a romantic honeymoon getaway or a relaxing family vacation, the Maldives’ resorts offer experiences tailored to every traveler’s desires.
                Adventure and Water Sports
                Beyond its beauty, the Maldives is a hub for water-based adventures. The calm, clear waters are perfect for snorkeling, scuba diving, and kayaking, while more adventurous visitors can indulge in jet skiing, windsurfing, or parasailing. The Maldives is home to some of the world’s most renowned dive sites, like Banana Reef and Manta Point, where you can swim alongside exotic marine life and explore stunning coral gardens.
                Cultural Experiences.
                
               {seeMore && (
               <span>
                Though the Maldives is best known for its natural beauty, it also has a rich cultural heritage influenced by its South Asian, African, and Arab history. Visitors can explore the capital city, Malé, which offers a glimpse into Maldivian culture with its bustling fish markets, local mosques, and historical landmarks like the 17th-century Hukuru Miskiy (Friday Mosque). The Maldives’ National Museum provides insight into the nation’s history, from ancient Buddhist relics to artifacts from the Islamic era.
                Cuisine
                Maldivian cuisine is a delicious fusion of flavors, with influences from India, Sri Lanka, and the Middle East. Fresh seafood, particularly tuna, is a staple, and dishes like garudhiya (fish soup), mas huni (tuna and coconut), and bajiya (samosa-like pastries) are must-tries. Many resorts offer a mix of international and local cuisine, allowing guests to experience gourmet dining while also savoring the authentic tastes of the islands. For a unique dining experience, some resorts feature underwater restaurants where you can enjoy a meal while surrounded by marine life.
                Relaxation and Wellness
                The Maldives is the epitome of relaxation, with many resorts offering world-class spa facilities. Guests can indulge in rejuvenating massages, facials, and wellness treatments, often performed in open-air pavilions overlooking the ocean. Yoga and meditation classes are also available, providing the perfect way to unwind and harmonize with the peaceful surroundings.
                Marine Conservation and Eco-Tourism
                Many Maldivian resorts are committed to sustainability and marine conservation efforts, making eco-tourism an important part of the Maldives experience. Guests can participate in coral restoration projects, sea turtle rehabilitation programs, and guided eco-tours to learn more about the local environment. The Maldives’ commitment to preserving its natural beauty ensures that future generations will continue to enjoy its wonders.
                Nightlife and Events
                Though the Maldives is often associated with serenity, it also offers lively entertainment, particularly within resort islands. Some resorts host beach parties, live music, and cultural shows, featuring traditional Maldivian music and dance performances. The calm, tropical evenings are also perfect for stargazing, sunset cruises, and romantic dinners on the beach, creating unforgettable memories.
                With its stunning natural beauty, luxurious accommodations, and wealth of activities, the Maldives is a dream destination for travelers seeking a tropical escape. Whether you’re looking to relax on the beach, explore vibrant coral reefs, or indulge in the finest luxuries, the Maldives promises an experience of pure paradise.
                </span>
              )}
              <span
        ...
        <div className="flex flex-wrap md:flex-row p-8 mt-8 mb-8 border-2 rounded-lg border-gray-600 w-full h-auto md:max-w-7xl">
          <div className="w-full md:w-44 md:h-44   h-60 flex items-center justify-center">
            <img src={Maldives} className="w-full h-full object-cover" alt="Maldives" />
          </div>

          <div className="ml-6 md:ml-8">
            <p className="text-lg md:text-2xl font-bold">PREMIUM MALDIVES INTERNATIONAL TRIP 10 NIGHTS 11 DAYS</p> 
