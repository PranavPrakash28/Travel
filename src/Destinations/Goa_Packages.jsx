  ...
  return (
    <>
      ...
      <div className="w-full font-oswald">
        <div className="w-full h-80 md:h-[500px] bg-cover bg-center" style={{ backgroundImage: `url(${Goa})` }}>
          {/* image */}
        </div>
      <div className='w-full h-auto flex  justify-center  px-4 md:px-0 font-oswald '>
        <div className="flex flex-col md:flex-row rounded-lg shadow-lg shadow-black text-md md:h-auto md:max-w-7xl mt-5 "> {/* Adjusted text size */}
          <div className="md:w-full p-5  md:h-auto">
            <p className="text-xl md:text-3xl font-bold  text-center"
            style={{textShadow:'2px 2px 4px rgba(0.5,0.5,0,0.5)'}}>Goa, India's Coastal Paradise: A Blend of Heritage and Modern Vibes</p> {/* Adjusted text size */}
            <p className="mt-2 text-md md:text-2xl pt-8 leading-6 md:leading-1">
            Goa, the sun-soaked gem of India, is a destination where golden beaches meet a vibrant culture steeped in history. Known for its serene coastline dotted with palm trees and lively beach shacks, Goa also preserves its rich Portuguese heritage through centuries-old churches, forts, and vibrant traditions. A visit to the iconic Basilica of Bom Jesus in Old Goa takes visitors back to the colonial era, while the bustling beaches of Baga and Calangute showcase the state’s lively and modern beach culture.
            The state is renowned for its colorful markets like Anjuna and Mapusa, where visitors can find everything from handmade crafts to bohemian fashion and local spices. Food lovers can indulge in Goa’s famous seafood and traditional dishes like prawn curry and vindaloo at beachside cafes or fine dining restaurants. For an authentic Goan experience, savor local specialties like feni, a traditional cashew liquor, while enjoying the sunset on a beach.        
              {seeMore && (
                <span>
                    Goa, the sun-soaked gem of India, is a destination where golden beaches meet a vibrant culture steeped in history. Known for its serene coastline dotted with palm trees and lively beach shacks, Goa also preserves its rich Portuguese heritage through centuries-old churches, forts, and vibrant traditions. A visit to the iconic Basilica of Bom Jesus in Old Goa takes visitors back to the colonial era, while the bustling beaches of Baga and Calangute showcase the state’s lively and modern beach culture.
                    The state is renowned for its colorful markets like Anjuna and Mapusa, where visitors can find everything from handmade crafts to bohemian fashion and local spices. Food lovers can indulge in Goa’s famous seafood and traditional dishes like prawn curry and vindaloo at beachside cafes or fine dining restaurants. For an authentic Goan experience, savor local specialties like feni, a traditional cashew liquor, while enjoying the sunset on a beach.
                    Beyond its beaches, Goa offers lush green spaces like the Dudhsagar Waterfalls and spice plantations, perfect for nature lovers seeking relaxation away from the coastal hustle. During the vibrant Carnival season, Goa comes alive with parades, music, and dance, showcasing the fusion of Indian and Portuguese cultures.
                    For adventure seekers and water sports enthusiasts, Goa’s beaches offer everything from parasailing to scuba diving, while the vibrant nightlife in places like Tito’s Lane and Candolim promises endless fun. Visitors can enjoy a night out at one of Goa’s legendary beach parties or relax with a cocktail at a chic rooftop bar with views of the Arabian Sea.
                    As the sun sets, Goa’s beach shacks transform into lively hotspots, with live music and bonfires, creating a magical after-dark atmosphere. Whether you're exploring the historic streets of Panaji or enjoying the laid-back coastal charm, Goa offers a perfect mix of cultural richness and modern leisure. From ancient churches to thrilling beach sports, Goa promises an unforgettable escape into a world of sun, sand, and heritage.
                </span>
              )}
              <span
    ...
    <div className='w-full h-auto flex-col  justify-center  px-4 md:px-32 font-oswald '>
        ...
        <div className="flex flex-wrap md:flex-row p-8 mt-8 mb-8 border-2 rounded-lg border-gray-600 w-full md:max-w-7xl">
          ...
          <div className="ml-6 md:ml-8">
            <p className="text-lg md:text-2xl font-bold">PREMIUM GOA DOMESTIC TRIP 10 NIGHTS 11 DAYS</p> 
          ...
          <div className="h-full ml-0 md:ml-20 mt-6 md:gap-6 md:mt-10  flex flex-col md:flex-row md:items-center justify-center">
            <Link to="/Booking_Form">
              <button className="px-4 py-2 md:mt-6 font-oswald w-fit bg-blue-600 text-white font-bold border-none text-md"> {/* Adjusted text size */}
                BOOK ONLINE
              </button>
            </Link>
            <Link to="/contact">
