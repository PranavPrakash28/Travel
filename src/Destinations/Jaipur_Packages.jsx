  ...
  return (
    <>
      ...
      <div className="w-full font-oswald">
        <div className="w-full h-80 md:h-[500px] bg-cover bg-center" style={{ backgroundImage: `url(${Jaipur})` }}>
          {/* image */}
        </div>
         
         <div className='w-full h-auto flex justify-center px-4 md:px-0 font-oswald '>
        <div className="flex flex-col md:flex-row max-w-7xl shadow-lg mt-5 shadow-black rounded-lg text-black text-md md:h-auto"> {/* Adjusted text size */}
          <div className="md:w-full p-5 md:h-auto">
            <p className="text-xl md:text-3xl font-bold text-center "
            style= {{textShadow:'2px 2px 4px rgba(0.5,0,0.5,0.5)'}}>Jaipur: The Enchanting Pink City of Royal Heritage</p> {/* Adjusted text size */}
            <p className="mt-2 text-md md:text-2xl pt-8 leading-6 md:leading-1">
            Jaipur, often referred to as the Pink City, offers a captivating blend of rich history, 
                    stunning architecture, and vibrant culture, making it a must-visit destination for travelers.
                    The city is famous for its magnificent palaces and forts, such as the iconic Hawa Mahal,
                    known for its intricate latticework and stunning facade, and the majestic Amber Fort,
                    which showcases a fusion of Hindu and Mughal architecture. Visitors can immerse themselves 
                    in the colorful bazaars of Jaipur, where traditional handicrafts, textiles, and jewelry can
                    be found, making for perfect souvenirs. The local cuisine is a culinary adventure of its own,
                    featuring mouthwatering dishes like Dal Baati Churma and Gatte ki Sabzi, often enjoyed in
                    authentic Rajasthani thali-style dining.
              {seeMore && (
                <span>
                    Jaipur, often referred to as the Pink City, offers a captivating blend of rich history, 
                    stunning architecture, and vibrant culture, making it a must-visit destination for travelers.
                    ...
                    featuring mouthwatering dishes like Dal Baati Churma and Gatte ki Sabzi, often enjoyed in
                    authentic Rajasthani thali-style dining.
                    For those seeking unique experiences, Jaipur offers opportunities for hot air balloon rides over the Aravalli hills,
                    providing a breathtaking aerial view of the city’s stunning landscapes. Adventure enthusiasts can explore
                    the rugged terrain of the surrounding areas on camel or elephant safaris.
                    As the sun sets, Jaipur transforms into a magical city with vibrant nightlife, featuring cultural performances,
                    music, and dance that celebrate its rich heritage. Whether you’re exploring ancient forts, indulging 
                    in delectable local cuisine, or experiencing the warm hospitality of the locals, Jaipur promises an 
        ...
        <div className='w-full h-auto flex-col  justify-center  px-4 md:px-32 font-oswald '>
            ...
            <div className="flex flex-wrap md:flex-row p-8 mt-8 mb-8 border-2 rounded-lg border-gray-600  md:max-w-7xl">
              <div className="w-full md:w-44 md:h-44   h-60 flex items-center justify-center">
                <img src={Jaipur} className="w-full h-full object-cover" alt="Jaipur" />
              </div>

              <div className="ml-6 md:ml-8">
                <p className="text-lg md:text-2xl font-bold">PREMIUM JAIPUR DOMESTIC TRIP 10 NIGHTS 11 DAYS</p> 
