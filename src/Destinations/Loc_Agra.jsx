  ...
  return (
    <>
      ...
      <div className="w-full font-oswald">
        <div className="w-full h-80 md:h-[500px] bg-cover bg-center" style={{ backgroundImage: `url(${Domestic3})` }}>
          {/* image */}
        </div>
        ...
        <div className="flex flex-col shadow-lg shadow-black rounded-lg mt-5 md:flex-row text-black text-md md:h-auto max-w-7xl"> 
          <div className="md:w-full p-5  md:h-auto">
            ...
            style={{textShadow: '2px 2px 4px rgba(0.5,0,0.5,0.5)'}}>Agra: A Fusion of Tradition and Modernity</p> 
            <p className="mt-2 text-md md:text-2xl pt-8 leading-6 md:leading-1">
            Agra, the historic gem of India, is a city where the grandeur of the past meets the vibrancy of modern life, offering travelers a unique journey through time. Renowned for housing one of the Seven Wonders of the World, the Taj Mahal, Agra’s skyline is dotted with architectural marvels from the Mughal era. A visit to the majestic Taj Mahal, a symbol of eternal love, is a once-in-a-lifetime experience, while the imposing Agra Fort takes visitors back to the time of emperors and royal courts.
            The city is equally known for its bustling markets like Sadar Bazaar and Kinari Bazaar, where visitors can find an array of traditional crafts, including marble inlay work, leather goods, and textiles. Agra’s culinary landscape is a treat for food lovers, offering everything from the famous Mughlai cuisine with dishes like biryani and kebabs to the sweet delight of petha, a local specialty.
              {seeMore && (
                <span>
                Agra, the historic gem of India, is a city where the grandeur of the past meets the vibrancy of modern life, offering travelers a unique journey through time. Renowned for housing one of the Seven Wonders of the World, the Taj Mahal, Agra’s skyline is dotted with architectural marvels from the Mughal era. A visit to the majestic Taj Mahal, a symbol of eternal love, is a once-in-a-lifetime experience, while the imposing Agra Fort takes visitors back to the time of emperors and royal courts.
                The city is equally known for its bustling markets like Sadar Bazaar and Kinari Bazaar, where visitors can find an array of traditional crafts, including marble inlay work, leather goods, and textiles. Agra’s culinary landscape is a treat for food lovers, offering everything from the famous Mughlai cuisine with dishes like biryani and kebabs to the sweet delight of petha, a local specialty.
                Beyond its historical attractions, Agra offers peaceful green spaces like Mehtab Bagh, which provides a stunning view of the Taj Mahal across the Yamuna River. The garden is the perfect place to unwind after exploring the city’s rich cultural heritage. Agra’s proximity to other historical sites, like Fatehpur Sikri, adds to its allure, offering travelers a glimpse into India’s ancient history and Mughal architecture.
                For a modern touch, Agra’s growing infrastructure, including the Agra-Lucknow Expressway, has made the city more accessible than ever, welcoming travelers with a mix of traditional charm and urban development. The city's shopping centers and emerging café culture offer a contemporary contrast to its historical roots.
                As evening falls, the beauty of the Taj Mahal at sunset or the glow of the Agra Fort under night lights creates a magical ambiance. Whether you're exploring the rich history or enjoying modern comforts, Agra ensures an unforgettable experience, blending the legacy of the past with the dynamism of the present. From its iconic landmarks to its vibrant markets and tranquil gardens, Agra offers a journey into the heart of India’s rich cultural and historical heritage.
                </span>
              )}
              <span
        ...
        <div className='w-full h-auto flex-col  justify-center  px-4 md:px-32 font-oswald '>
            ...
            <div className="flex flex-wrap md:flex-row p-8 mt-8 mb-8  border-2 rounded-lg border-gray-600 w-full md:max-w-7xl">
              <div className="w-full md:w-44 md:h-44   h-60 flex items-center justify-center">
                <img src={Agra} className="w-full h-full object-cover" alt="Agra" />
              </div>

              <div className="ml-6 md:ml-8">
                <p className="text-lg md:text-2xl font-bold">PREMIUM AGRA DOMESTIC TRIP 10 NIGHTS 11 DAYS</p> 
