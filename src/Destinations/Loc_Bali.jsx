        ...
        <div className="flex flex-col md:flex-row shadow-lg rounded-2xl shadow-black mt-10 md:max-w-7xl mx-auto px-4 text-md md:h-96"> 
          <div className="md:w-3/4 p-5 border-r-2 border-gray-600 md:h-auto">
            <p className="text-xl md:text-4xl font-bold"
              style={{ textShadow: '2px 2px 4px rgba(1, 0, 0.5, 0.5)' }}>Bali a serene Beauty</p> 
            <p className="mt-2 text-md md:text-2xl pt-8 leading-6 md:leading-1">
              Bali, often referred to as the “Island of the Gods,” is a tropical paradise in Indonesia, attracting millions of tourists each year. Known for its stunning beaches, vibrant culture, and lush green landscapes, Bali offers a perfect mix of relaxation, adventure, and cultural immersion.
              {seeMore && (
                <span>
                  Bali’s unique blend of natural beauty and rich culture creates an unparalleled experience for visitors. The island is renowned for its world-class yoga retreats, spa experiences, and vibrant nightlife, especially in areas like Seminyak and Kuta. Adventure seekers can enjoy water sports, jungle treks, and exploring hidden waterfalls.
                </span>
              )}
              <span
          ...
          <div className="md:w-1/4 text-sm h-auto md:text-sm bg-white text-black p-5 md:block"> 
            ...
            <p className="pt-5 cursor-pointer" onClick={() => handleAboutClick('exclusive')}>Exclusive Bali Packages</p>
            <p className="pt-2 cursor-pointer" onClick={() => handleAboutClick('restaurants')}>Must Visit Restaurants</p>
            <p className="pt-2 cursor-pointer" onClick={() => handleAboutClick('places')}>Things to do in Bali</p>
            <p className="pt-2 cursor-pointer" onClick={() => handleAboutClick('nightlife')}>Night life in Bali</p>
      ...
      <div className='w-full h-auto flex-col  justify-center  px-4 md:px-32 font-oswald '> 
        ...
        <div className="flex flex-wrap md:flex-row p-8 mt-8 mb-8 border-2 rounded-lg border-gray-600 w-full md:max-w-7xl mx-auto">
          <div className="w-full md:w-44 md:h-44   h-60 flex items-center justify-center">
            <img src={Bali} className="w-full h-full object-cover" alt="Bali" />
          </div>

          <div className="ml-6 md:ml-8">
            <p className="text-lg md:text-2xl font-bold">PREMIUM BALI INTERNATIONAL TRIP 10 NIGHTS 11 DAYS</p> 
          ...
          <div className="md:max-w-7xl md:mx-auto text-xl md:text-3xl  rounded-3xl shadow-black shadow-2xl p-5 md:block " ref={targetDivRef}>
            ...
            {expandedContent === 'exclusive' && (
              <div className="pt-2 md:text-xl font-light">
                <p>1. Nusa Penida Island: Just a short boat ride from Bali, this island offers pristine beaches, dramatic cliffs, and world-class snorkeling and diving spots.</p>
                <p>2. Sekumpul Waterfall: One of Bali’s most picturesque waterfalls, nestled in the northern part of the island and surrounded by lush rainforest.</p>
            ...
            {expandedContent === 'restaurants' && (
              <div className="pt-2 md:text-xl font-light">
                <p>Bali is known for its diverse culinary scene, from traditional Balinese dishes to international cuisine. Must-try local dishes include:</p>
                <ul>
                  <li>- Nasi Goreng: Indonesia’s classic fried rice, often served with a fried egg on top.</li>
                  <li>- Babi Guling: Roasted suckling pig, a traditional Balinese delicacy.</li>
            ...
            {expandedContent === 'nightlife' && (
              <div className="pt-2 md:text-xl font-light">
                <p>The ideal time to visit Bali is during the dry season, from April to October, when the weather is sunny and pleasant, making it perfect for outdoor activities, beach visits, and exploring temples.</p>
              </div>
            )}
