  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 font-oswald">
        <Link to='/Loc_Europe'><p className="text-3xl font-bold mb-7">EUROPE</p></Link>
        <p className="mt-2 text-md md:text-lg pt-8 leading-6 md:leading-1 mb-7">
        <span className="text-xl md:text-3xl font-semibold">Unveiling <Link to='/Loc_Europe'className="text-red-600 hover:underline cursor-pointer">Europe&apos;s</Link> Timeless Beauty <br/></span>
