  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 font-oswald">
        <Link to= '/domestic'><p className="text-3xl  font-bold ">DOMESTIC</p></Link>
        <p className="mt-2 text-md md:text-lg pt-8 leading-6 mb-7 md:leading-1 ">
        <span className="md:text-3xl text-xl font-semibold"> Discover India&apos;s Incredible  <Link to='/domestic' className="text-red-600 hover:cursor-pointer hover:underline ">Domestic</Link> Travel Destinations<br/></span>
                  India is a country of breathtaking contrasts, where every corner offers a new experience. Whether you&apos;re craving serenity, adventure, or cultural immersion, India&apos;s domestic travel scene has it all. Let&apos;s dive into some of the most spectacular destinations you must explore:
                  {/* Uttarakhand<br/>
              ...
              {seeMore && (
                <span>
                  ...
                  <br/>
                  Uttarakhand<br/>
                  Nestled in the Himalayas, Uttarakhand is a spiritual and nature lover&apos;s paradise. Home to the famous Char Dham Yatra (Badrinath, Kedarnath, Gangotri, and Yamunotri), this state offers spiritual renewal in its sacred temples and a close encounter with raw natural beauty. Don&apos;t miss the adventure capital Rishikesh, known for river rafting and yoga, and Mussoorie, the &qout;Queen of Hills,&qout; offering enchanting views of the Himalayas.<br/>
                  Himachal Pradesh<br/>
                  From the valleys of Kullu and Manali to the serene, spiritual retreat of Dharamshala, Himachal is an ideal mix of adventure and tranquility. Explore the isolated charm of the Spiti Valley, known for its rugged terrain and Buddhist monasteries, or experience the beauty of Shimla, a colonial hill station full of charm. Trekking, paragliding, and skiing are popular activities here for adventure seekers.<br/>
                  Andaman & Nicobar Islands<br/>
                  If pristine beaches and crystal-clear waters are what you&apos;re after, the Andaman Islands are the perfect escape. Visit Radhanagar Beach, one of the best in Asia, or indulge in water sports like snorkeling and scuba diving in Havelock Island. The rich marine life and untouched coral reefs make it a must-visit for nature lovers.<br/>
                  <Link to='/Kerala' className="text-red-600 hover:cursor-pointer hover:underline">Kerala</Link><br/>
                  <Link to='/Kerala' className="text-red-600 hover:cursor-pointer hover:underline">Kerala</Link>, aptly named &qout;God&apos;s Own Country,&qout; is known for its serene backwaters, lush tea gardens, and vibrant culture. Take a houseboat ride in Alleppey, relax on the beaches of Kovalam, or experience the wildlife of Thekkady. Kerala&apos;s lush hills in Munnar offer an aromatic journey through tea plantations, making it a scenic retreat.<br/>
                  Karnataka<br/>
                  Karnataka is a treasure trove of cultural and natural wonders. Explore the mist-covered hills of Coorg, often referred to as the &qout;Scotland of India,&qout; or witness the ancient ruins of Hampi, a UNESCO World Heritage Site. The bustling city of Bangalore is known for its tech hubs and vibrant nightlife, while Mysore enchants with its palatial architecture and grand history.<br/>
                  ...
                  Meghalaya<br/>
                  In the heart of the Northeast, Meghalaya is home to lush landscapes and the mystical Living Root Bridges. Visit Cherrapunji, one of the wettest places on earth, and marvel at the cascading waterfalls and green valleys. The capital city, Shillong, often called the &qout;Scotland of the East,&qout; is a great place to enjoy cool weather, serene lakes, and a vibrant music scene.<br/>
                  Sikkim<br/>
