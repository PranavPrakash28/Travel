...
const Himachal_Hidden_Gems = [
    { img: TirthanValley, duration: '5 Days & 4 Nights', text: 'Tirthan Valley | Serene Valleys and Trout Fishing', price: 'INR 28000' },
    { img: SpitiValley, duration: '7 Days & 6 Nights', text: 'Spiti Valley | Remote Deserts and Monasteries', price: 'INR 45000' },
    { img: Chitkul, duration: '4 Days & 3 Nights', text: 'Chitkul | India’s Last Village and Scenic Beauty', price: 'INR 24000' },
    { img: Shoja, duration: '5 Days & 4 Nights', text: 'Shoja | Tranquil Villages and Meadows', price: 'INR 26000' },
    { img: BarotValley, duration: '6 Days & 5 Nights', text: 'Barot Valley | Fishing, Trekking and Nature Retreat', price: 'INR 32000' },
    { img: Jibhi, duration: '5 Days & 4 Nights', text: 'Jibhi | Hidden Paradise and Waterfalls', price: 'INR 25000' },
    { img: Kalpa, duration: '6 Days & 5 Nights', text: 'Kalpa | Apple Orchards and Views of Kinnaur Kailash', price: 'INR 30000' },
    { img: ParvatiValley, duration: '5 Days & 4 Nights', text: 'Parvati Valley | Enchanting Valleys and Spiritual Vibes', price: 'INR 27000' },
    { img: Narkanda, duration: '4 Days & 3 Nights', text: 'Narkanda | Snow-Capped Peaks and Apple Orchards', price: 'INR 22000' },
    { img: BirBilling, duration: '6 Days & 5 Nights', text: 'Bir Billing | Paragliding Capital and Monasteries', price: 'INR 35000' },
  ];
                ...
                <div className="bg-black bg-opacity-40 absolute inset-0 rounded-lg">
                  ...
                  <div className="absolute bottom-4 right-4">
                    <Link to="/Booking_Form">
                      <button className="text-white border-2 border-white rounded-lg px-4 py-2">BOOK NOW</button>
                    </Link>
                  </div>
                </div>
              </div>
