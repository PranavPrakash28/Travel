  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 font-oswald">
       <Link to='/international'> <p className="text-3xl font-bold mb-7">INTERNATIONAL</p></Link>
        <Slider {...settings}>
       ...
       <span className="text-xl text-bold"> Discover the World’s Most Incredible  <Link to='/international' className="text-red-600 hover:cursor-pointer hover:underline">International</Link> Travel Destinations</span>
              ...
              {seeMore && (
                <span>
                  {/* Discover the World’s Most Incredible International Travel Destinations
                  <br/>
                  Ready to venture beyond borders and explore some of the most stunning international locations? From tropical paradises to culturally rich destinations, the world is full of breathtaking experiences waiting to be discovered. Let’s take a journey through some of the top international destinations you should add to your travel bucket list:
                  <br/> */}
                  <br/>
                  Vietnam<br/>
                  ...
                  <br/>
                  <Link to='/Loc_Bali' className="text-red-600 hover:underline cursor-pointer">Bali</Link>, Indonesia<br/>
